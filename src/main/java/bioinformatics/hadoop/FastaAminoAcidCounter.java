...
/**
 * Created by attilacsordas on 07/01/2014.
 */

public class FastaAminoAcidCounter extends Configured implements Tool {
...
*/
        ...
        public int runJob(Configuration conf, String[] args) throws Exception {
            ...
            Job job = new Job(conf, "fastaaminoacidcounter");
            ...
            job.setJarByClass(FastaAminoAcidCounter.class);
...
/*        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(IntWritable.class);*/
            ...
            job.setInputFormatClass(org.systemsbiology.hadoop.FastaInputFormat.class);
...
//        }
        ...
        public static void main(String[] args) throws Exception {
            ...
            new FastaAminoAcidCounter().run(args);
        }
