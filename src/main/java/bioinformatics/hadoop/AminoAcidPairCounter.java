...
/**
 * Created by attilacsordas on 10/02/2014.
 */
public class AminoAcidPairCounter extends Configured implements Tool {
...
//                    String n = new StringBuilder().append(line.charAt(i)).toString();
                    ...
                    // key: byte offset, zero-based number of bytes to index a file, using ASCII characters only byte offset = character offset
    ...
    public int runJob(Configuration conf, String[] args) throws Exception {
        ...
        Job job = new Job(conf, "aminoacidpaircounter");
        ...
        job.setJarByClass(AminoAcidPairCounter.class);
...
//        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new AminoAcidPairCounter().run(args);
    }
