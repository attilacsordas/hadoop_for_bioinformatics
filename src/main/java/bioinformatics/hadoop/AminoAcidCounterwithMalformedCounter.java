...
public class AminoAcidCounterwithMalformedCounter extends Configured implements Tool {
    ...
    public int runJob(Configuration conf, String[] args) throws Exception {
        ...
        Job job = new Job(conf, "aminoacidcounterwithmalformedcounter");
        ...
        job.setJarByClass(AminoAcidCounterwithMalformedCounter.class);
...
//        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new AminoAcidCounterwithMalformedCounter().run(args);
    }
