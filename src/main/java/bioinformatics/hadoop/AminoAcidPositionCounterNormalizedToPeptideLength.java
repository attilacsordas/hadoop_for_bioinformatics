...
public class AminoAcidPositionCounterNormalizedToPeptideLength extends Configured implements Tool {
    ...
    public int runJob(Configuration conf, String[] args) throws Exception {
        ...
        Job job = new Job(conf, "aminoacidpositioncounternormalizedtopeptidelength");
        ...
        job.setJarByClass(AminoAcidPositionCounterNormalizedToPeptideLength.class);
...
//        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new AminoAcidPositionCounterNormalizedToPeptideLength().run(args);
    }
